      ...
      case "ONBOARDING_ALUMNI": {
        try {
          ...
          const record: any = {
            ...
            institution: data.institution || data.institution || null,
            school_faculty: data.schoolFaculty || data.school_faculty || null,
            field_of_study: data.fieldOfStudy || data.field_of_study || null,
          ...
          try {
            const res = await db.submitOnboardingForm({
              ...
              institution: data.institution || data.institution || undefined,
              schoolFaculty: data.schoolFaculty || data.school_faculty || undefined,
              fieldOfStudy: data.fieldOfStudy || data.field_of_study || undefined,
